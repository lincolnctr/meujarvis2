...
# ---------------------------------------------------------
# 1. INTERFACE HUD (ESTILO STARK - ESTABILIZADA)
# ---------------------------------------------------------
...
with st.sidebar:
    ...
    if st.checkbox("LOG DE MODIFICAÇÕES"):
        st.info("Status: Personalidade Restaurada para Modo Assistente Britânico.")
...
# ---------------------------------------------------------
# 4. PROCESSAMENTO E PERSONALIDADE (MODO JARVIS)
# ---------------------------------------------------------
...
if prompt := st.chat_input("Comando, Senhor Lincoln..."):
    ...
    with st.chat_message("assistant", avatar=JARVIS_ICONE):
        ...
        sys_msg = (
            f"Você é o J.A.R.V.I.S., o assistente britânico leal e sofisticado do Senhor Lincoln. "
